    ...
    return (
        ...
        <div className="bg-white shadow-lg rounded-lg flex flex-col max-w-7xl md:flex-row w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                {/* Password Input */}
                <div>
                <label className="block text-[#999999] font-medium text-[13px]">Password</label>
                <div className="flex items-center border-b-2 border-gray-300 focus-within:border-[#000842]">
                    <img
                    src={passwordIcon}
                    alt="Email Icon"
                    ...
                    >
                    <img className="w-8" src={showPassword ? ShowEye :HideEye} alt="" />
                    </button>
                </div>
                ...
                <label className="flex items-center">
                    ...
                    <span className="text-[12px] font-light text-[#000000] ">Remember me</span>
                </label>
            ...
            {/* Social Login */}
            <p className="mt-8 text-center text-[16px] font-medium text-[#B5B5B5]">or continue with</p>
